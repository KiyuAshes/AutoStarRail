...
ASR_INTERFACE IAsrSettingsForUi;
...
ASR_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IAsrContext, IAsrBase);
...
ASR_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IAsrSettingsForUi, IAsrBase);
...
ASR_UTILS_DEFINE_PRESET_INHERITANCE_INFO(IAsrSwigContext, IAsrSwigBase);
