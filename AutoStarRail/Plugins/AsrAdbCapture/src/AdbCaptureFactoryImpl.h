#ifndef ASR_PLUGINS_ASRADBCAPTURE_ADBCAPTUREFACTORYIMPL_H
#define ASR_PLUGINS_ASRADBCAPTURE_ADBCAPTUREFACTORYIMPL_H
...
#endif // ASR_PLUGINS_ASRADBCAPTURE_ADBCAPTUREFACTORYIMPL_H
